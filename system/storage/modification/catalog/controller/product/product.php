	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['heading_title'] = $product_info['name'];
						...
						/* = */
						$data['alt_image'] = isset($product_info['alt_image']) ? $product_info['alt_image'] : '';
						$data['title_image'] = isset($product_info['title_image']) ? $product_info['title_image'] : '';
				
						if(isset($product_info['seo_h1']) && $product_info['seo_h1']){
						$data['heading_title'] = $product_info['seo_h1'];
						}
						
						if(isset($product_info['seo_h2']) && $product_info['seo_h2']){
						$data['seo_h2'] = $product_info['seo_h2'];
						}
						
						if(isset($product_info['seo_h3']) && $product_info['seo_h3']){
						$data['seo_h3'] = $product_info['seo_h3'];
						}
						...
						$data['seo_h2_position'] = $entity['seo_h2']['product']['position'];
						$data['seo_h3_position'] = $entity['seo_h3']['product']['position']; 
						...
						if($tools){
							...
							$data['breadcrumbs'] = $breadAndPath->getProductBreadcrumb(
							$data['breadcrumbs'], 
							$set_bread['mode'], 
							$set_bread['reverse'], 
							$set_add['title'], 
