...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="
    					pull-right"><?php if ($shipping_code == 'novaposhta.novaposhta') { ?><a href="<?php echo $novaposhta_ei; ?>" data-toggle="tooltip" title="<?php echo $button_create_ei; ?>" class="btn btn-danger" target="_blank"><i class="fa fa-header"></i></a> <?php } ?>
...
$.ajax({
	...
	success: function(json) {
        ...
        if (json['error']) {
            ...
            if (json['error']['ip']) {
    			$('#content > .container-fluid').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['ip'] + ' <button type="button" id="button-ip-add" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger btn-xs 
    					pull-right"><?php if ($shipping_code == 'novaposhta.novaposhta') { ?><a href="<?php echo $novaposhta_ei; ?>" data-toggle="tooltip" title="<?php echo $button_create_ei; ?>" class="btn btn-danger" target="_blank"><i class="fa fa-header"></i></a> <?php } ?>
    				<i class="fa fa-plus"></i> <?php echo $button_ip_add; ?></button></div>');
    		}
        }
