          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<div class="col-sm-10"><input type="text" name="seodata[<?php echo $language['language_id']; ?>][seo_h2]" value="<?php echo isset($seodata[$language['language_id']]['seo_h2']) ? $seodata[$language['language_id']]['seo_h2'] : ''; ?>" id="input-h1-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo H2" /></div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label" for="input-h1-title<?php echo $language['language_id']; ?>">Seo H3</label>
				<div class="col-sm-10"><input type="text" name="seodata[<?php echo $language['language_id']; ?>][seo_h3]" value="<?php echo isset($seodata[$language['language_id']]['seo_h3']) ? $seodata[$language['language_id']]['seo_h3'] : ''; ?>" id="input-h1-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo H3" /></div>
				</div>
