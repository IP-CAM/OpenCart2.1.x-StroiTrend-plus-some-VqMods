...
<div id="confirm_wrap">
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<button id="qc_confirm_order" class="btn btn-primary btn-lg btn-block buttoncardinverse" <%= model.show_confirm ? '' : 'disabled="disabled"' %>><% if(Number(model.payment_popup)) { %><?php echo $button_continue; ?><% }else{ %><?php echo $button_confirm; ?><% } %></span></button>
