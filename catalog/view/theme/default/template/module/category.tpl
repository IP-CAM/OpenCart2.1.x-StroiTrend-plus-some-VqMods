...
<?php 
   ...
   foreach ($categories as $category) { ?>
    <?php if ($category['category_id'] == $category_id || false !== strpos($_SERVER['REQUEST_URI'], 'mm')) { ?>
...
<?php foreach ($category['children'] as $child) { ?>
<div class="col-md-3 col-sm-6 list-unstyled " style="margin-bottom:10px;">
<div class="box">
<li>
<p class="fplay fsize16 grey">
<a href="<?php echo $child['href']; ?>" class="nonewhbg" style="border:none !important; padding:0px; ">
<?php echo $child['name']; ?>
</a>
...
<a href="<?php echo $child['href']; ?>"  class="ma_punkt" > Подробнее </a>
</div>
</li>
</div>
</div>
